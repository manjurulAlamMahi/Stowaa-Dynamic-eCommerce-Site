                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<div class="header-info">
										...
										<p class="fs-12 mb-0">@foreach ( Auth::user()->roles->pluck('name')  as $role_name)
                                            {{ $role_name }}
                                        @endforeach</p>
									</div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ route('user_profile') }}" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{ route('role_manager') }}" aria-expanded="false">
							<i class="fa-solid fa-network-wired"></i>
							<span class="nav-text">Role Manager</span>
						</a>
                    </li>
                    <li>
                        <a href="{{ route('assgin_role') }}" aria-expanded="false">
							<i class="fa-solid fa-users-gear"></i>
							<span style="font-size:14px;" class="nav-text">Assgin Role To User's</span>
						</a>
                    </li>
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('users_table') }}">User List</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('view_product') }}">Product List</a></li>
                            <li><a href="{{ route('add_variation') }}">Inventory Variation</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('add_coupon') }}">Add Coupon</a></li>
                            <li><a href="{{ route('view_coupon') }}">Coupon List</a></li>
                        </ul>
                    </li>
                </ul>
			</div>
